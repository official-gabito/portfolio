...
export default function AboutSection() {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-20 bg-gray-50 dark:bg-dark-card/20">
      <div className="container mx-auto px-4">
        <motion.div 
          ...
          transition={{ duration: 0.6 }}
        >
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">About <span className="text-primary">Me</span></h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              With over 3 years of experience in mobile and web development, I specialize in creating user-focused 
              applications that deliver exceptional performance and clean code. Based in {profileData.location}, 
              I've worked with clients across various industries to bring their digital ideas to life.
            </motion.p>
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              My expertise spans Flutter, React, Firebase, JavaScript, Node.js, SQL, HTML, and CSS, allowing me to build 
              comprehensive solutions from concept to deployment. I'm particularly passionate about mobile-first design 
