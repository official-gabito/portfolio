...
export default function ContactSection() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-20 bg-gray-50 dark:bg-dark-card/20">
      <div className="container mx-auto px-4">
        <motion.div 
          ...
          transition={{ duration: 0.6 }}
        >
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">Get In <span className="text-primary">Touch</span></h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          <motion.div 
            className="lg:col-span-3 bg-white dark:bg-dark-card p-8 rounded-xl shadow-lg"
          ...
          <div className="lg:col-span-2">
            <motion.div 
              className="bg-white dark:bg-dark-card p-8 rounded-xl shadow-lg mb-8"
