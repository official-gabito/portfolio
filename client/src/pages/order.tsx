        ...
        <motion.div className="max-w-4xl mx-auto">
          ...
          <motion.div variants={itemVariants} className="text-center mb-10">
            <h1 className="font-heading text-3xl md:text-4xl font-bold mb-4">
              {orderSuccess ? 'Order Submitted Successfully!' : `Order ${selectedPlan.name}`}
            </h1>
            {!orderSuccess && (
          ...
          {orderSuccess ? (
            ...
            >
              ...
              <h2 className="font-heading text-2xl font-bold mb-4">Thank You for Your Order!</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                I've received your order details and will contact you shortly to discuss the next steps.
              </p>
            ...
            >
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl mb-8">
                <h3 className="font-heading text-xl font-bold mb-2">Selected Package:</h3>
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Project Details */}
                <div>
                  <h3 className="font-heading text-xl font-bold mb-4">Project Details</h3>
                  ...
                  <div className="relative mb-6">
                    <motion.label 
                      ...
                      className="absolute left-4 top-3.5 origin-left pointer-events-none text-gray-500 transition-all duration-200"
                      variants={floatingLabelVariants}
                      animate={focusedField === 'projectDescription' || formData.projectDescription ? "focused" : "default"}
                    >
                      Project Description
                    </motion.label>
                    ...
                    <textarea 
                      ...
                      onBlur={() => setFocusedField(null)}
                      placeholder="Please describe your project in detail, including its purpose, target audience, and key features."
                    ></textarea>
                    ...
                    <motion.div 
                      ...
                      variants={focusIndicatorVariants}
                      initial="hidden"
                      animate={focusedField === 'projectDescription' ? "visible" : "hidden"}
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="relative">
                      <motion.label 
                        ...
                        className="absolute left-4 top-3.5 origin-left pointer-events-none text-gray-500 transition-all duration-200"
                        variants={floatingLabelVariants}
                        animate={focusedField === 'timeline' || formData.timeline ? "focused" : "default"}
                      >
                        Preferred Timeline
                      </motion.label>
                      ...
                      <input 
                        ...
                        onBlur={() => setFocusedField(null)}
                        placeholder="e.g., 4 weeks, 2 months, ASAP"
                      />
                      ...
                      <motion.div 
                        ...
                        variants={focusIndicatorVariants}
                        initial="hidden"
                        animate={focusedField === 'timeline' ? "visible" : "hidden"}
                      />
                    </div>
                    ...
                    <div className="relative">
                      <motion.label 
                        ...
                        className="absolute left-4 top-3.5 origin-left pointer-events-none text-gray-500 transition-all duration-200"
                        variants={floatingLabelVariants}
                        animate={focusedField === 'budget' || formData.budget ? "focused" : "default"}
                      >
                        Budget
                      </motion.label>
                  ...
                  <div className="relative mb-6">
                    <motion.label 
                      ...
                      className="absolute left-4 top-3.5 origin-left pointer-events-none text-gray-500 transition-all duration-200"
                      variants={floatingLabelVariants}
                      animate={focusedField === 'references' || formData.references ? "focused" : "default"}
                    >
                    ...
                    <textarea 
                      ...
                      onBlur={() => setFocusedField(null)}
                      placeholder="List any websites, apps, or designs that inspire you or are similar to what you're looking for."
                    ></textarea>
                    ...
                    <motion.div 
                      ...
                      variants={focusIndicatorVariants}
                      initial="hidden"
                      animate={focusedField === 'references' ? "visible" : "hidden"}
                    />
                  </div>
                  ...
                  <div className="relative">
                    <motion.label 
                      ...
                      className="absolute left-4 top-3.5 origin-left pointer-events-none text-gray-500 transition-all duration-200"
                      variants={floatingLabelVariants}
                      animate={focusedField === 'additionalInfo' || formData.additionalInfo ? "focused" : "default"}
                    >
                    ...
                    <textarea 
                      ...
                      onBlur={() => setFocusedField(null)}
                      placeholder="Any other information you'd like to share about your project or requirements."
                    ></textarea>
                    ...
                    <motion.div 
                      ...
                      variants={focusIndicatorVariants}
                      initial="hidden"
                      animate={focusedField === 'additionalInfo' ? "visible" : "hidden"}
                    />
                  </div>
                </div>
